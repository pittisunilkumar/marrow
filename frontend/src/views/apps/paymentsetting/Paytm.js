...
const Paytm = () => {
  ...
  return (
    <Grid container>
        ...
        <Grid item xs={12}>
          <CustomTextField id="bl-message" placeholder="Merchant Key *" fullWidth />
        </Grid>
        ...
        <Grid item xs={12}>
          <CustomTextField id="bl-message" placeholder="Merchant id *" fullWidth />
        </Grid>
        ...
        <Grid item xs={12}>
          <CustomTextField id="bl-message" placeholder="Merchant Website Link *" fullWidth />
        </Grid>
        ...
        <Grid item xs={12}>
          <CustomTextField id="bl-message" value="paytm" disabled placeholder="Payment Gateway Title *" fullWidth />
        </Grid>
